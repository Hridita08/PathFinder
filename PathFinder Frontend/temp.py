...
# Points to current directory for HTML files
...
def login():
    ...
    if user:
        ...
        # Returns login page with error if credentials fail
...
def forgot_password():
    if request.method == 'POST':
        ...
        if user:
            # Renders the verification page with the question from database
...
def verify_answer():
    ...
    # Checks if security answer matches
